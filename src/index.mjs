...
console.log(
  "The statement that there are at least two odd numbers is " + isTwoOdd,
);
...
console.log(
  `The first number is larger than the last is ${firstLargerThanLast}`,
);
...
function crossCountryRoadTripCostCalculator(
  totalDistance,
  speed,
  milePerGallon,
  fuelBudget,
